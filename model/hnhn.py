...
class HNHN(nn.Module):
    r"""The HNHN convolution layer proposed in ``HNHN: Hypergraph Networks with Hyperedge Neurons'' paper (ICML 2020).
    ...
    def __init__(
        ...
        self.layers = nn.ModuleList([HNHNConv(in_channels=hid_channels,
